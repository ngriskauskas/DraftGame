...
namespace Draft.Inf.Migrations
{
    ...
    [Migration("20190821195225_Init8")]
    partial class Init8
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Draft.Core.Entities.Roster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Draft.Core.Entities.Player", b =>
                {
                    b.HasOne("Draft.Core.Entities.Roster")
                        .WithMany("Players")
            ...
            modelBuilder.Entity("Draft.Core.Entities.Team", b =>
                {
                    ...
                    b.HasOne("Draft.Core.Entities.Roster", "Roster")
                        .WithMany()
                        .HasForeignKey("RosterId");
